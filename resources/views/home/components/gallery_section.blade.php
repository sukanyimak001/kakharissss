<div class="section gallery row" data-aos="fade-up">
    <div class="col">
        ...
        <div style="width: 100%">
            <span style="color: black; font-size: 32px; font-weight: 400; line-height: 41.60px;">Lihat
            </span><span
                style="color: #0F21FF; font-size: 32px; font-weight: 600; line-height: 41.60px;">Galeri</span><span
